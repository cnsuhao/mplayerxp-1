...
#include "../mplayerxp/__mp_msg.h"
#include "../mplayerxp/cpudetect.h"
#include "../mplayerxp/libvo/fastmemcpy.h"
...
#include "../linux.drivers/mga_vid.h"
...
int main( void )
{
  ...
  GetCpuCaps(&gCpuCaps);
    ...
    gCpuCaps.hasSSE2=0;
#endif
  MSG_INFO("CPUflags: MMX: %d MMX2: %d 3DNow: %d 3DNow2: %d SSE: %d SSE2: %d\n",
