...
//============ Open DEMUXERS --- DETECT file type =======================
    ...
    if(!input_state.after_dvdmenu) demuxer=demux_open(stream,file_format,audio_id,video_id,dvdsub_id);
...
//================ SETUP AUDIO ==========================
    ...
    audio_time_usage=0; audio_decode_time_usage=0; video_time_usage=0;
