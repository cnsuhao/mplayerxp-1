...
#endif
extern void mp_input_register_options(M_Config& cfg);
extern void libmpdemux_register_options(M_Config& cfg);
extern void demuxer_register_options(M_Config& cfg);
