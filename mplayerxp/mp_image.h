...
#define MP_IMGFLAG_ACCEPT_ALIGNED_STRIDE 0x4 /* no flag - should be neg value of MP_IMGFLAG_ACCEPT_STRIDE */
// stride should be aligned to MB boundary:     [for buffer allocation]
#define MP_IMGFLAG_PREFER_ALIGNED_STRIDE 0x8 /* sould be no flag - everything prefer aligned strides */
