...
#define MP_IMGFLAG_ACCEPT_ALIGNED_STRIDE 0x04 /* no flag - should be neg value of MP_IMGFLAG_ACCEPT_STRIDE */
// stride should be aligned to MB boundary:     [for buffer allocation]
#define MP_IMGFLAG_PREFER_ALIGNED_STRIDE 0x08 /* sould be no flag - everything prefer aligned strides */
...
#define MP_IMGFLAG_COMMON_STRIDE	0x40 /* UNUSED */
// uses only planes[0], and calculates planes[1,2] from width,height,imgfmt
#define MP_IMGFLAG_COMMON_PLANE		0x80 /* UNUSED */
...
// buffer is video memory
#define MP_IMGFLAG_FINAL		0x10000
// final buffer was already painted
#define MP_IMGFLAG_RENDERED		0x20000
// indicates final step of image processing from CPU side!!!
#define MP_IMGFLAG_FINALIZED		0x40000
...
extern mp_image_t* new_mp_image(int w,int h);
