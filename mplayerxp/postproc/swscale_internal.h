...
#include "../mp_msg.h"
#define MSG_INFO(args...) mp_msg(MSGT_SWS,MSGL_INFO,__FILE__,__LINE__,##args )
#define MSG_FATAL(args...) mp_msg(MSGT_SWS,MSGL_FATAL,__FILE__,__LINE__,##args )
#define MSG_WARN(args...) mp_msg(MSGT_SWS,MSGL_WARN,__FILE__,__LINE__,##args )
#define MSG_ERR(args...) mp_msg(MSGT_SWS,MSGL_ERR,__FILE__,__LINE__,##args )
#define MSG_V(args...) mp_msg(MSGT_SWS,MSGL_V,__FILE__,__LINE__,##args )
#define MSG_OK(args...) mp_msg(MSGT_SWS,MSGL_OK,__FILE__,__LINE__,##args )
#define MSG_DBG2(args...) mp_msg(MSGT_SWS,MSGL_DBG2,__FILE__,__LINE__,##args )
#define MSG_DBG3(args...) mp_msg(MSGT_SWS,MSGL_DBG3,__FILE__,__LINE__,##args )
#define MSG_HINT(args...) mp_msg(MSGT_SWS,MSGL_HINT,__FILE__,__LINE__,##args )
#define MSG_STATUS(args...) mp_msg(MSGT_SWS,MSGL_STATUS,__FILE__,__LINE__,##args )
