...
mm_support(void)
{
	...
	*/
	...
	__asm__ __volatile__ (
		...
		/* ... Get copies of EFLAGS into "REG_a" and "REG_c" */
		"pushf\n\t"
		"popl %%"REG_a"\n\t"
		"movl %%"REG_a", %%"REG_c"\n\t"
		...
		/* The value of CPUID/80000001 for the 6x86MX is undefined
		   ...
		   Rev. 1.01 table 1), so we'll check the value of "REG_a" for
		...
		*/
		...
		/* Extended CPUID supported (in theory), so get extended
		   features */
		"movl $0x80000001, %%"REG_a"\n\t"
		"cpuid\n\t"
		"testl $0x00800000, %%"REG_a"\n\t"	/* Test for MMX */
		"jz NotSupported5\n\t"		/* MMX not supported */
		"testl $0x01000000, %%"REG_a"\n\t"	/* Test for Ext'd MMX */
		"jnz EMMXSupported\n\t"
		"movl $1, %0:\n\n\t"		/* MMX Supported */
		"jmp Return\n\n"
		"EMMXSupported:\n\t"
