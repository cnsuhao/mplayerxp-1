...
#define MSGTR_CreatingCfgFile "Creando archivo de configuración"
#define MSGTR_InvalidVOdriver "Nombre del driver de salida de video incorrecto"
#define MSGTR_InvalidAOdriver "Nombre del driver de salida de audio incorrecto"
#define MSGTR_CopyCodecsConf "(copie/ln etc/codecs.conf (en el árbol del codigo fuente de MPlayerXP) a ~/.mplayerxp/codecs.conf)\n"
#define MSGTR_CantLoadFont "No se puede cargar la fuente"
#define MSGTR_CantLoadSub "No se puede cargar el subtítulo"
...
#define MSGTR_TryForceAudioFmt "Tratando de forzar la familia del codec de audio"
...
#define MSGTR_TryForceVideoFmt "Tratando de forzar la familia del codec de video"
