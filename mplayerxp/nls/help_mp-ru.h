...
" vcdnav://<номер трека> играть VCD (video cd) трек с устройства вместо файла\n"
#ifdef HAVE_LIBCSS
" -dvdauth <dev>  выбор устройства DVD для авторизации (для шифрованных дисков)\n"
#endif
#ifdef USE_DVDREAD
" dvdread://<номер титра> играть DVD титр/трек с устройства вместо файла\n"
#endif
...
" -vf pp=de -af crystality   разрешить постпроцессный фильтр\n"
