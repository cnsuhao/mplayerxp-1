...
#define MSGTR_CreatingCfgFile "Genererer konfig fil"
#define MSGTR_InvalidVOdriver "Ugyldig valg af video driver"
#define MSGTR_InvalidAOdriver "Ugyldig valg af lyd driver"
#define MSGTR_CopyCodecsConf "(kopier/linker etc/codecs.conf (fra MPlayerXP kilde (source) katalog) til ~/.mplayerxp/codecs.conf)\n"
#define MSGTR_CantLoadFont "Kan ikke loade fonten"
#define MSGTR_CantLoadSub "Kan ikke loade undertekst-filen"
...
#define MSGTR_TryForceAudioFmt "Prøver at tvinge en lyd codec driver familie"
...
#define MSGTR_TryForceVideoFmt "Prøver at tvinge en video codec driver familie"
