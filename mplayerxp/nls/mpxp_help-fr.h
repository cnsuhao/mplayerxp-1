...
#define MSGTR_CreatingCfgFile "Création du fichier de config"
#define MSGTR_InvalidVOdriver "Nom du pilote de sortie vidéo invalide"
#define MSGTR_InvalidAOdriver "Nom du pilote de sortie audio invalide"
#define MSGTR_CopyCodecsConf "(Copiez/liez etc/codecs.conf (dans le source de MPlayerXP) vers ~/.mplayerxp/codecs.conf)\n"
#define MSGTR_CantLoadFont "Ne peut charger la police"
#define MSGTR_CantLoadSub "Ne peut charger les sous-titres"
...
#define MSGTR_TryForceAudioFmt "Tente de forcer famille de pilotes codec audio de famille"
...
#define MSGTR_TryForceVideoFmt "Tente de forcer famille de pilotes codec vidéo"
...
#define MSGTR_NoLAVCsupport "MPlayerXP a été compilé SANS le support lavc/libavcodec!\n"
