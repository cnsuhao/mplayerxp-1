...
#define MSGTR_CreatingCfgFile "Vytváram konfiguračný súbor"
#define MSGTR_InvalidVOdriver "Neplatné meno výstupného videoovládača"
#define MSGTR_InvalidAOdriver "Neplatné meno výstupného audioovládača"
#define MSGTR_CopyCodecsConf "(copy/ln etc/codecs.conf (zo zdrojových kódov MPlayerXPu) do ~/.mplayerxp/codecs.conf)\n"
#define MSGTR_CantLoadFont "Nemôžem načítať font"
#define MSGTR_CantLoadSub "Nemôžem načítať titulky"
...
#define MSGTR_TryForceAudioFmt "Pokúšam sa vynútiť rodinu audiokodeku"
...
#define MSGTR_TryForceVideoFmt "Pokúšam se vnútiť rodinu videokodeku"
...
#define MSGTR_NoLAVCsupport "MPlayerXP bol preložený BEZ podpory lavc/libavcodec!\n"
