...
#define MSGTR_CreatingCfgFile "Creez fişierul de configurare"
#define MSGTR_InvalidVOdriver "Ieşire video invalidă"
#define MSGTR_InvalidAOdriver "Ieşire audio invalidă"
#define MSGTR_CopyCodecsConf "(copiaţi etc/codecs.conf (din directorul sursă MPlayerXP) în  ~/.mplayerxp/codecs.conf)\n"
#define MSGTR_CantLoadFont "Nu pot incărca fontul"
#define MSGTR_CantLoadSub "Nu pot incarcă subtitrarea"
...
#define MSGTR_TryForceAudioFmt "Încerc să forţez utilizarea unui codec audio din familia"
...
#define MSGTR_TryForceVideoFmt "Încerc să forţez utilizarea unui codec video din familia"
...
#define MSGTR_NoLAVCsupport "MPlayerXP a fost compilat FĂRĂ suport lavc/libavcodec!\n"
