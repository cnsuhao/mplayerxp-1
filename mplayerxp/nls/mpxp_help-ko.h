...
#define MSGTR_InvalidVOdriver "는 잘못된 비디오 출력 드라이버입니다"
#define MSGTR_InvalidAOdriver "는 잘못된 오디오 출력 드라이버입니다"
#define MSGTR_CopyCodecsConf "((MPlayerXP 소스 트리의) etc/codecs.conf를 ~/.mplayerxp/codecs.conf로 복사 또는 링크하세요.)\n"
#define MSGTR_CantLoadFont "폰트를 찾을 수 없습니다"
#define MSGTR_CantLoadSub "자막을 찾을 수 없습니다"
...
#define MSGTR_TryForceAudioFmt "오디오 코덱 드라이버 류를 시도하고 있습니다"
...
#define MSGTR_TryForceVideoFmt "비디오 코덱 드라이버 류를 시도하고 있습니다"
