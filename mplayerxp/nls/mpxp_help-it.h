...
#define MSGTR_CreatingCfgFile "Creo il file di configurazione"
#define MSGTR_InvalidVOdriver "Nome del diver video di output non valido"
#define MSGTR_InvalidAOdriver "Nome del diver audio di output non valido"
#define MSGTR_CopyCodecsConf "(copia/collega etc/codecs.conf (dall\'albero dei sorgenti di MPlayerXP) a ~/.mplayerxp/codecs.conf)\n"
#define MSGTR_CantLoadFont "Impossibile caricare i font"
#define MSGTR_CantLoadSub "Impossibile caricare i sottotitoli"
...
#define MSGTR_TryForceAudioFmt "Cerco di forzare l\'uso della famiglia dei driver dei codec audio"
...
#define MSGTR_TryForceVideoFmt "Cerco di forzare l\'uso della famiglia dei driver dei codec video"
...
#define MSGTR_NoLAVCsupport "MPlayerXP è stato compilato SENZA il supporto per lavc/libavcodec \n"
