...
" vcdnav://<nrpiste>   Joue une piste VCD (Vidéo CD) d'un périphérique plutôt\n"
"                  que d'un fichier\n"
#ifdef HAVE_LIBCSS
...
#endif
#ifdef USE_DVDREAD
" dvdread://<nrtitre>   Joue titre/piste DVD d'un périph. plutôt que d'un fichier\n"
#endif
...
" -vf pp=de -af crystality    Active le filtre de sortie\n"
