...
#define MSGTR_CreatingCfgFile "Bezig met het creëren van config bestand"
#define MSGTR_InvalidVOdriver "Foutieve video uitvoer driver naam"
#define MSGTR_InvalidAOdriver "Foutieve audio uitvoer driver naam"
#define MSGTR_CopyCodecsConf "(copy/ln etc/codecs.conf (van MPlayerXP source tree) naar ~/.mplayerxp/codecs.conf)\n"
#define MSGTR_CantLoadFont "Kan font niet laden"
#define MSGTR_CantLoadSub "Kan ondertitels niet lezen"
...
#define MSGTR_TryForceAudioFmt "Probeer audio codec driver familie te forceren"
...
#define MSGTR_TryForceVideoFmt "Probeer video codec driver familie te forceren"
