...
dca_resample_t dca_resample_init(dca_state_t * state,uint32_t _mm_accel,int flags,int chans){
dca_resample_t tmp;
...
dca_resample32_t dca_resample_init_float(dca_state_t * state,uint32_t _mm_accel,int flags,int chans){
dca_resample32_t tmp;
