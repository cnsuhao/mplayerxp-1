...
static dca_resample_t dca_resample_C(dca_state_t * state,int flags, int ch){
    bias=state->bias;
    level=state->level;
    switch (flags) {
    case DCA_MONO:
...
static inline float normalize_f (float i)
{
    return  (i-bias)/level;
}

static int dca_resample_MONO_to_5_f32(float * f, float * s32){
    int i;
	for (i = 0; i < 256; i++) {
...
static int dca_resample_MONO_to_1_f32(float * f, float * s32){
    int i;
	for (i = 0; i < 256; i++) {
...
static int dca_resample_STEREO_to_2_f32(float * f, float * s32){
    int i;
	for (i = 0; i < 256; i++) {
...
static int dca_resample_3F_to_5_f32(float * f, float * s32){
    int i;
	for (i = 0; i < 256; i++) {
...
static int dca_resample_2F_2R_to_4_f32(float * f, float * s32){
    int i;
	for (i = 0; i < 256; i++) {
...
static int dca_resample_3F_2R_to_5_f32(float * f, float * s32){
    int i;
	for (i = 0; i < 256; i++) {
	    s32[5*i] = normalize_f (f[i]);
	    s32[5*i+1] = normalize_f (f[i+512]);
...
static int dca_resample_MONO_LFE_to_6_f32(float * f, float * s32){
    int i;
	for (i = 0; i < 256; i++) {
...
static int dca_resample_STEREO_LFE_to_6_f32(float * f, float * s32){
    int i;
	for (i = 0; i < 256; i++) {
...
static int dca_resample_3F_LFE_to_6_f32(float * f, float * s32){
    int i;
	for (i = 0; i < 256; i++) {
	    s32[6*i] = normalize_f (f[i+256]);
...
static int dca_resample_2F_2R_LFE_to_6_f32(float * f, float * s32){
    int i;
	for (i = 0; i < 256; i++) {
	    s32[6*i] = normalize_f (f[i+256]);
	    s32[6*i+1] = normalize_f (f[i+512]);
...
static int dca_resample_3F_2R_LFE_to_6_f32(float * f, float * s32){
    int i;
	for (i = 0; i < 256; i++) {
	    s32[6*i] = normalize_f (f[i+256]);
	    s32[6*i+1] = normalize_f (f[i+768]);
...
static dca_resample32_t dca_resample_f32(dca_state_t * state,int flags, int ch){
    bias=state->bias;
    level=state->level;
    switch (flags) {
    case DCA_MONO:
