...
static a52_resample_t a52_resample_C(a52_state_t * state,int flags, int ch){
    bias=state->bias;
    level=state->level;
    switch (flags) {
    case A52_MONO:
...
static int a52_resample_MONO_to_5_f32(float * f, real_t * s32){
    int i;
	for (i = 0; i < 256; i++) {
...
static int a52_resample_MONO_to_1_f32(float * f, real_t * s32){
    int i;
	for (i = 0; i < 256; i++) {
...
static int a52_resample_STEREO_to_2_f32(float * f, real_t * s32){
    int i;
	for (i = 0; i < 256; i++) {
...
static int a52_resample_3F_to_5_f32(float * f, real_t * s32){
    int i;
	for (i = 0; i < 256; i++) {
...
static int a52_resample_2F_2R_to_4_f32(float * f, real_t * s32){
    int i;
	for (i = 0; i < 256; i++) {
...
static int a52_resample_3F_2R_to_5_f32(float * f, real_t * s32){
    int i;
	for (i = 0; i < 256; i++) {
	    s32[5*i] = normalize_f (f[i]);
	    s32[5*i+1] = normalize_f (f[i+512]);
...
static int a52_resample_MONO_LFE_to_6_f32(float * f, real_t * s32){
    int i;
	for (i = 0; i < 256; i++) {
...
static int a52_resample_STEREO_LFE_to_6_f32(float * f, real_t * s32){
    int i;
	for (i = 0; i < 256; i++) {
...
static int a52_resample_3F_LFE_to_6_f32(float * f, real_t * s32){
    int i;
	for (i = 0; i < 256; i++) {
	    s32[6*i] = normalize_f (f[i+256]);
...
static int a52_resample_2F_2R_LFE_to_6_f32(float * f, real_t * s32){
    int i;
	for (i = 0; i < 256; i++) {
	    s32[6*i] = normalize_f (f[i+256]);
	    s32[6*i+1] = normalize_f (f[i+512]);
...
static int a52_resample_3F_2R_LFE_to_6_f32(float * f, real_t * s32){
    int i;
	for (i = 0; i < 256; i++) {
	    s32[6*i] = normalize_f (f[i+256]);
	    s32[6*i+1] = normalize_f (f[i+768]);
...
static a52_resample32_t a52_resample_f32(a52_state_t * state,int flags, int ch){
    bias=state->bias;
    level=state->level;
    switch (flags) {
    case A52_MONO:
	if(ch==5) return a52_resample_MONO_to_5_f32;
	if(ch==1) return a52_resample_MONO_to_1_f32;
	break;
    case A52_CHANNEL:
    case A52_STEREO:
    case A52_DOLBY:
	if(ch==2) return a52_resample_STEREO_to_2_f32;
	break;
    case A52_3F:
	if(ch==5) return a52_resample_3F_to_5_f32;
	break;
    case A52_2F2R:
	if(ch==4) return a52_resample_2F_2R_to_4_f32;
	break;
    case A52_3F2R:
	if(ch==5) return a52_resample_3F_2R_to_5_f32;
	break;
    case A52_MONO | A52_LFE:
	if(ch==6) return a52_resample_MONO_LFE_to_6_f32;
	break;
    case A52_CHANNEL | A52_LFE:
    case A52_STEREO | A52_LFE:
    case A52_DOLBY | A52_LFE:
	if(ch==6) return a52_resample_STEREO_LFE_to_6_f32;
	break;
    case A52_3F | A52_LFE:
	if(ch==6) return a52_resample_3F_LFE_to_6_f32;
	break;
    case A52_2F2R | A52_LFE:
	if(ch==6) return a52_resample_2F_2R_LFE_to_6_f32;
	break;
    case A52_3F2R | A52_LFE:
	if(ch==6) return a52_resample_3F_2R_LFE_to_6_f32;
	break;
    }
    return NULL;
}
