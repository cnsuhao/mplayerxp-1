...
static void __FASTCALL__ mpxp_stream_event_handler(const struct stream_s *s,const stream_packet_t *sp)
{
...
//================== Init AUDIO (codec) ==========================
    ...
    priv->ao_inited=(RND_RENAME4(ao_register)(ao_data,mp_conf.audio_driver,0)!=NULL)?1:0;
