...
** $Id: mp4.c,v 1.3 2004/10/27 18:13:10 nickols_k Exp $
...
char *faac_subdecoders[] = 
{
"NULL","Main","LC","SSR","LTP","SBR","Scalable","TwinVQ",
"CELP","HVXC","Reserved1","Reserved2","TTSI","Main synthetic","Wavetable synthesis",
"General MIDI","Algorithmic Synthesis and Audio FX","ER LC","ER LTP",
"ER scalable","ER TwinVQ","ER BSAC","ER LD","ER CELP","ER HVXC",
"ER HILN","ER Parametric","ER LC","Reserved3","ER LTP","ER scalable",
"ER TwinVQ","ER BSAC","ER LD","ER CELP","ER HVXC","ER HILN","ER Parametric",
                                    ...
                                    program_config *pce)
{
    ...
    {
	printf("libfaac: Can't find '%s' subdecoder\n",faac_subdecoders[mp4ASC->objectTypeIndex&0x1F]);
        faad_endbits(&ld);
        return -1;
    }
    ...
    {
	printf("libfaac: Sampling frequency 0\n");
        faad_endbits(&ld);
        return -2;
    }
    ...
    {
	printf("libfaac: Can't support %u channels (max. 7)\n",mp4ASC->channelsConfiguration);
        faad_endbits(&ld);
        return -3;
    }
