...
MODULE_AUTHOR("Nickols_K <nickols_k@mail.ru>");
#ifdef RAGE128
...
static int __init radeon_vid_initialize(void)
{
	radeon_vid_in_use = 0;
#ifdef RAGE128
	printk(RVID_MSG"Rage128/Rage128Pro video overlay driver v"RADEON_VID_VERSION" (C) Nickols_K\n");
#else
	printk(RVID_MSG"Radeon video overlay driver v"RADEON_VID_VERSION" (C) Nickols_K\n");
#endif
